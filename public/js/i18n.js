  ...
  const DICT = {
    de: {
      meta: {
        ...
        titleStats: 'Statistik · Passwortmanager Übungs-Demo',
      },
      nav: {
      ...
      stats: {
        badge: 'Anonyme Nutzungs-Statistik',
        h1: 'Statistik',
        sub: 'Ein paar Zahlen darüber, wie diese Übungsseite genutzt wird. Alles ist anonym und aggregiert.',
        refresh: 'Aktualisieren',
        updatedAt: 'Stand:',
        loadError: 'Statistik konnte nicht geladen werden.',
        last24h: '24 h',
        overviewTitle: 'Überblick',
        overviewSub: 'Aktuelle Momentaufnahme der Übungsseite.',
        activeAccounts: 'Aktive Accounts',
        withTotp: 'davon mit 2FA',
        registeredPasskeys: 'Hinterlegte Passkeys',
        successRate: 'Login-Erfolgsquote',
        accountsTitle: 'Accounts',
        accountsSub: 'Anlegen, Löschen und Abmelden über die gesamte Laufzeit.',
        accountCreated: 'Erstellt (gesamt)',
        accountDeleted: 'Selbst gelöscht',
        accountPruned: 'Automatisch aufgeräumt',
        logouts: 'Abmeldungen',
        loginSuccessTitle: 'Erfolgreiche Logins',
        loginSuccessSub: 'Gelungene Anmeldungen nach Methode.',
        loginPassword: 'Nur Passwort',
        login2fa: 'Mit 2FA',
        loginPasskey: 'Mit Passkey',
        loginFailTitle: 'Fehlgeschlagene Logins',
        loginFailSub: 'Abgelehnte Anmeldeversuche nach Methode.',
        loginFailPassword: 'Passwort falsch',
        loginFail2fa: '2FA-Code falsch',
        loginFailPasskey: 'Passkey abgelehnt',
        securityTitle: 'Sicherheits-Funktionen',
        securitySub: 'Wie oft 2FA und Passkeys ein- bzw. ausgeschaltet wurden.',
        twofaEnabled: '2FA aktiviert',
        twofaDisabled: '2FA deaktiviert',
        passkeyAdded: 'Passkeys hinzugefügt',
        passkeyRemoved: 'Passkeys entfernt',
        privacyNote: 'Datenschutz: Es werden ausschließlich anonyme Summen gespeichert – keine Benutzernamen, Passwörter, 2FA-Secrets oder personenbezogenen Daten.',
      },
      errors: {
    ...
    en: {
      meta: {
        ...
        titleStats: 'Statistics · Password Manager Practice Demo',
      },
      nav: {
      ...
      stats: {
        badge: 'Anonymous usage statistics',
        h1: 'Statistics',
        sub: 'A few numbers about how this practice site is used. Everything is anonymous and aggregated.',
        refresh: 'Refresh',
        updatedAt: 'As of:',
        loadError: 'Statistics could not be loaded.',
        last24h: '24 h',
        overviewTitle: 'Overview',
        overviewSub: 'Current snapshot of the practice site.',
        activeAccounts: 'Active accounts',
        withTotp: 'of those with 2FA',
        registeredPasskeys: 'Registered passkeys',
        successRate: 'Login success rate',
        accountsTitle: 'Accounts',
        accountsSub: 'Creating, deleting and signing out over the whole lifetime.',
        accountCreated: 'Created (total)',
        accountDeleted: 'Deleted by user',
        accountPruned: 'Auto-cleaned',
        logouts: 'Sign-outs',
        loginSuccessTitle: 'Successful logins',
        loginSuccessSub: 'Successful sign-ins by method.',
        loginPassword: 'Password only',
        login2fa: 'With 2FA',
        loginPasskey: 'With passkey',
        loginFailTitle: 'Failed logins',
        loginFailSub: 'Rejected sign-in attempts by method.',
        loginFailPassword: 'Wrong password',
        loginFail2fa: 'Wrong 2FA code',
        loginFailPasskey: 'Passkey rejected',
        securityTitle: 'Security features',
        securitySub: 'How often 2FA and passkeys were turned on or off.',
        twofaEnabled: '2FA enabled',
        twofaDisabled: '2FA disabled',
        passkeyAdded: 'Passkeys added',
        passkeyRemoved: 'Passkeys removed',
        privacyNote: 'Privacy: only anonymous totals are stored – no usernames, passwords, 2FA secrets or personal data.',
      },
      errors: {
